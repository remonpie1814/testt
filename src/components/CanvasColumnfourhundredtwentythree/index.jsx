...
const CanvasColumnfourhundredtwentythree = (props) => {
  return (
    <>
...
CanvasColumnfourhundredtwentythree.defaultProps = {
...
export default CanvasColumnfourhundredtwentythree;
