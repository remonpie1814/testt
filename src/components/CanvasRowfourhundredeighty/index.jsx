...
const CanvasRowfourhundredeighty = (props) => {
  return (
    <>
...
CanvasRowfourhundredeighty.defaultProps = {};

export default CanvasRowfourhundredeighty;
