...
const CanvasRowfourhundredthirtyfive = (props) => {
  return (
    <>
...
CanvasRowfourhundredthirtyfive.defaultProps = {};

export default CanvasRowfourhundredthirtyfive;
