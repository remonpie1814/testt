    ...
    <>
      <div className={props.className}>
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start max-w-[1180px] w-full">
          ...
          <div className="border-gray-400_02 border-l border-solid border-t flex flex-1 flex-col h-[67px] md:h-auto items-start justify-start max-w-[773px] w-full">
        ...
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start max-w-[1180px] w-full">
          ...
          <div className="bg-white-A700_0f border-gray-400_02 border-l border-solid border-t flex flex-1 flex-col h-[67px] md:h-auto items-start justify-start max-w-[773px] w-full">
            <div className="flex flex-col h-full items-center justify-center px-3 py-2.5 w-full">
              <Text
                className="text-base text-black-900 w-auto"
                size="txtInterRegular16"
        ...
        <div className="flex md:flex-col flex-row md:gap-5 h-[66px] md:h-auto items-start justify-start max-w-[1180px] w-full">
          <Button
            className="!text-white-A700 border-gray-400_02 border-l border-solid border-t cursor-pointer flex-1 font-bold font-inter h-[66px] text-[22px] text-center sm:text-lg md:text-xl w-full"
            shape="square"
            color="gray_600"
            size="lg"
            variant="fill"
          ...
          <div className="border-gray-400_02 border-l border-solid border-t flex flex-1 flex-col h-[66px] md:h-auto items-start justify-start max-w-[773px] w-full">
            <div className="flex flex-col h-full items-center justify-center px-3 py-2.5 w-full">
              <Text
                className="text-base text-black-900 w-auto"
                size="txtInterRegular16"
