...
const Columntwohundredthirtyone = (props) => {
  return (
    <>
...
Columntwohundredthirtyone.defaultProps = {
  twohundredthirtyone: "계정 탈퇴하기",
};

export default Columntwohundredthirtyone;
