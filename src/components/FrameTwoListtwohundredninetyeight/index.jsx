...
const FrameTwoListtwohundredninetyeight = (props) => {
  return (
    <>
...
FrameTwoListtwohundredninetyeight.defaultProps = {
  twohundredninetyeight: <>&gt;</>,
};

export default FrameTwoListtwohundredninetyeight;
