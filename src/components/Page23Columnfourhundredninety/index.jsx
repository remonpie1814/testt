...
const Page23Columnfourhundredninety = (props) => {
  return (
    <>
...
Page23Columnfourhundredninety.defaultProps = {
...
export default Page23Columnfourhundredninety;
