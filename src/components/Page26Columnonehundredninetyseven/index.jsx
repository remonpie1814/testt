...
const Page26Columnonehundredninetyseven = (props) => {
  return (
    <>
...
Page26Columnonehundredninetyseven.defaultProps = {
...
export default Page26Columnonehundredninetyseven;
