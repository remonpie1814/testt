      ...
      <div className={props.className}>
        <div className="flex md:flex-col flex-row gap-[30px] items-center justify-start w-full">
          <div className="flex md:flex-1 flex-col items-center justify-start w-[26%] md:w-full">
            <Img
              className="h-[393px] md:h-auto object-cover rounded-bl-[5px] rounded-br-[5px] w-full"
...
Page29ColumnOne.defaultProps = {
  twentyeight: "토끼와 호랑이",
  twentynine: "···",
  p20231006: "작성일 2023.10.06",
  thirty: <>가나다라마바사아자차카 &gt;</>,
  twentythree: "23",
  one: "1",
  five: "5",
...
export default Page29ColumnOne;
