...
const Page29Columnspeakerfilledau = (props) => {
  return (
    <>
          ...
          <div className="h-[393px] relative w-[26%] md:w-full">
            ...
            <div className="absolute flex flex-col items-center justify-center p-5 right-[0] top-[0] w-20">
              <Img
                ...
                src="images/img_speakerfilledaudiotool_40x40.png"
                alt="speakerfilledau"
              />
            </div>
          </div>
...
Page29Columnspeakerfilledau.defaultProps = {
  username: "토끼와 호랑이",
  userdescription: "···",
  datecreated: "작성일 2023.10.06",
  userdescription2: <>가나다라마바사아자차카 &gt;</>,
  usernumber: "23",
  usernumber2: "1",
  usernumber3: "5",
  userdescription3:
...
export default Page29Columnspeakerfilledau;
