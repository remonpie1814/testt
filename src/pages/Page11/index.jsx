...
import Columntwohundredseventy from "components/Columntwohundredseventy";
    ...
    <>
      <div className="bg-white-A700 flex flex-col font-inter items-center justify-start mx-auto w-auto sm:w-full md:w-full">
        ...
        <div className="flex flex-col gap-10 h-[1482px] md:h-auto items-center justify-start max-w-[1180px] mx-auto md:px-5 py-[31px] w-full">
          ...
          <Columntwohundredseventy className="flex flex-col gap-[15px] items-start justify-center w-full" />
