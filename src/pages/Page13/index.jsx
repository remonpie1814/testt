              ...
              <div className="flex relative w-[230px]">
                <div className="h-5 my-auto w-[61%] sm:w-full">
                  <CheckBox
                    ...
                    name="ThreeHundredFiftyTwo"
                    id="ThreeHundredFiftyTwo"
                    label="아이디 저장"
                    color="white_A700"
                    size="xs"
                    variant="fill"
                  ...
                  <CheckBox
                    className="font-medium my-auto text-[15px] text-left tracking-[-0.17px]"
                    inputClassName="absolute h-5 mr-[5px] outline outline-[2px] outline-gray-300 rounded-sm w-5"
                    name="ThreeHundredFiftyThree"
                    id="ThreeHundredFiftyThree"
                    label="아이디 저장"
                    color="white_A700"
                    size="xs"
                    variant="fill"
                ...
                <CheckBox
                  ...
                  name="ThreeHundredFiftyFour"
                  id="ThreeHundredFiftyFour"
                  label="자동로그인"
                  color="white_A700"
                  size="xs"
                  variant="fill"
