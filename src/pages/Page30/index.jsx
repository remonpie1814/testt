...
import Columnseventythree from "components/Columnseventythree";
...
const Page30 = () => {
  const columnseventythreePropList = [{}, {}, {}, {}, {}, { username: "멍멍" }];
  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-inter items-center justify-start mx-auto shadow-bs w-auto sm:w-full md:w-full">
        ...
        <div className="flex flex-col gap-[22px] h-[1614px] md:h-auto items-center justify-start max-w-[1180px] mx-auto md:px-5 py-5 w-full">
            ...
            <div className="flex md:flex-col flex-row md:gap-[57px] items-start justify-between pt-8 w-full">
              <div className="h-[248px] relative w-[17%] md:w-full">
                ...
                <div
                  ...
                  style={{ backgroundImage: "url('images/img_group1568.svg')" }}
                >
                  <Img
          ...
          <div className="flex flex-row gap-[21px] h-full items-start justify-end w-full">
          ...
          <div className="flex flex-col h-[211px] md:h-auto items-center justify-start w-full">
            ...
            <div className="flex md:flex-col flex-row gap-8 items-center justify-start px-[3px] py-5 w-full">
              ...
              >
                {columnseventythreePropList.map((props, index) => (
                  <React.Fragment key={`Columnseventythree${index}`}>
                    <Columnseventythree
              ...
              <Columnseventythree
                className="flex flex-col gap-3 items-center justify-start w-auto"
                userimage="images/img_image607.png"
              />
            </div>
          </div>
