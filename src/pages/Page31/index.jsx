...
import Page31Columnfourhundredseventyeight from "components/Page31Columnfourhundredseventyeight";
import Page31Rowthumbsup from "components/Page31Rowthumbsup";
      ...
      <div className="bg-white-A700 flex flex-col font-inter items-center justify-start mx-auto w-auto sm:w-full md:w-full">
        ...
        <div className="bg-blue_gray-100 flex md:flex-col flex-row md:gap-5 items-start justify-start w-full">
          <Sidebar className="!sticky !w-[400px] bg-gray-600_7f flex h-screen md:hidden justify-start overflow-auto md:px-5 top-[0]">
            <Page31Columnfourhundredseventyeight
          ...
          <Img
            ...
            alt="One_Nine"
          />
          <Page31Rowthumbsup className="flex flex-1 sm:flex-col flex-row sm:gap-10 items-start justify-between ml-3.5 md:ml-[0] md:px-5 py-[50px] w-full" />
        </div>
      </div>
      {isOpenPage23Modal ? (
        <Page23Modal
