...
import Columnfivehundredthree from "components/Columnfivehundredthree";
  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-inter gap-2.5 items-start justify-start mx-auto w-auto sm:w-full md:w-full">
        ...
        <Columnfivehundredthree className="flex flex-col gap-2.5 h-[231px] md:h-auto items-center justify-center w-full" />
      </div>
    </>
  );
};
