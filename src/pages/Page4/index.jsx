      ...
      <div className="bg-white-A700 flex flex-col font-inter items-center justify-start mx-auto shadow-bs w-auto sm:w-full md:w-full">
        ...
        <div className="flex flex-col gap-5 h-[1554px] md:h-auto items-center justify-start max-w-[720px] md:px-5 py-5 w-full">
          <div className="flex flex-col items-center justify-start w-full">
            <div className="flex md:flex-col flex-row gap-[17px] items-center justify-start sm:pr-5 pr-[38px] w-full">
              <div className="h-[248px] relative w-[29%] md:w-full">
                <div className="absolute h-[248px] inset-[0] justify-center m-auto w-full">
                  ...
                  <div className="absolute bottom-[23%] flex flex-col items-end justify-start right-[27%] w-[21%]">
                    <Img
                      className="h-2 w-2"
                    ...
                    />
                    <Img
                      className="h-0.5 mr-[13px] mt-[11px]"
                      src="images/img_vector1329.svg"
                      alt="vector1329"
                    />
                  </div>
                </div>
                <div className="absolute bottom-[23%] flex flex-row items-start justify-center right-[9%] w-1/4">
              ...
              <div className="flex sm:flex-1 flex-col h-[248px] md:h-auto items-start justify-start w-[474px] sm:w-full">
                <Text
                ...
                <Text
                  className="leading-[150.00%] max-w-[474px] md:max-w-full text-base text-gray-600 tracking-[-0.18px]"
            ...
            <div className="flex flex-col items-end justify-start md:pl-10 sm:pl-5 pl-[342px] w-full">
              <div className="flex sm:flex-col flex-row gap-[18px] items-start justify-start w-auto sm:w-full">
                <div className="h-[47px] relative w-[41%] sm:w-full">
                  <div className="h-[47px] m-auto rounded-[3px] w-full"></div>
                  <div className="absolute h-[21px] left-[14%] rotate-[-90deg] rounded-[3px] top-[26%] w-[11%]"></div>
                </div>
                <div className="h-[47px] rounded-[3px] w-[56%]"></div>
              </div>
            </div>
          </div>
          <div className="flex flex-col gap-5 items-center justify-start w-full">
            ...
            <div className="flex md:flex-col flex-row gap-[35px] items-center justify-between px-[3px] w-full">
              ...
              <List
                className="md:flex-1 sm:flex-col flex-row gap-[37px] grid grid-cols-2 w-[37%] md:w-full"
          ...
          <div className="flex flex-col items-center justify-start md:px-10 sm:px-5 px-[127px] w-full">
            <div className="bg-blue_gray-100 flex flex-col items-center justify-start p-2 w-full">
              <div className="flex flex-row gap-[30px] items-start justify-between w-[410px] sm:w-full">
                <div className="flex flex-col h-[133px] md:h-auto items-center justify-start">
                ...
                <List
                  className="sm:flex-col flex-row gap-[30px] grid grid-cols-2 w-[47%]"
                  orientation="horizontal"
                >
                  <div className="flex flex-col gap-[7px] items-center justify-start w-auto">
                    <Img
          ...
          <div className="flex flex-col gap-5 items-center justify-start py-5 w-full">
            ...
            >
              {new Array(3).fill({}).map((props, index) => (
                <React.Fragment key={`Columntwo${index}`}>
                  <Columntwo
                    className="flex flex-1 flex-col gap-[7px] items-center justify-start w-full"
                    {...props}
                  />
                </React.Fragment>
              ))}
          ...
          <div className="flex md:flex-col flex-row gap-5 items-start justify-between max-w-[720px] w-full">
            <div className="bg-white-A700 border border-black-900 border-solid flex md:flex-1 flex-col items-center justify-end p-3 w-[85%] md:w-full">
            ...
            <div className="h-[135px] px-[11px] relative w-[16%] md:w-full">
