...
import Columntwohundredfourteen from "components/Columntwohundredfourteen";
      ...
      <div className="bg-white-A700 flex flex-col font-inter items-center justify-start mx-auto w-auto sm:w-full md:w-full">
        ...
        <div className="flex flex-col gap-10 items-center justify-start max-w-[1182px] mx-auto pt-[30px] md:px-5 w-full">
          ...
          >
            ...
            <Columntwohundredfourteen className="border-2 border-blue_gray-900 border-solid flex flex-col items-center justify-start my-0 p-2 rounded-[16px] w-full" />
          </List>
        </div>
      </div>
    </>
