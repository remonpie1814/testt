  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-inter items-center justify-start mx-auto w-auto sm:w-full md:w-full">
        ...
        <div className="flex flex-col gap-[45px] items-center justify-start max-w-[1180px] mx-auto md:px-5 py-[31px] w-full">
          <Text
          ...
          <div className="flex flex-col h-[89px] md:h-auto items-center justify-center w-full">
            <div className="flex flex-row gap-[33px] items-center justify-center w-[32%]">
